...
export const MOCK_HOST_CONTEXT: HostContext = {
  issuerBankCode: 'HDFC',
  country: 'IN',
  mobileAppUserId: 'USR_1202',
  customerId: 'CUST_1202',
  ...
  accountNumber: '9987402179122',
  primaryAccountNumber: '631633482122',
  selectedBankAccountNumber: '900625216944122',
  poolAccount: 'POOL_DEFAULT',

  recipientName: 'Amit Sharma',
  recipientPhoneNumber: '+919876543122',
  recipientEmail: 'sunil.codewrap022@gmail.com',
};
