...
export const MOCK_HOST_CONTEXT: HostContext = {
  issuerBankCode: 'HDFC',
  country: 'IN',
  mobileAppUserId: 'USR_0232',
  customerId: 'CUST_2337',
  ...
  accountNumber: '9987402173437',
  primaryAccountNumber: '631633483437',
  selectedBankAccountNumber: '900625216943437',
  poolAccount: 'POOL_DEFAULT',

  recipientName: 'Amit Sharma',
  recipientPhoneNumber: '+919876543447',
  recipientEmail: 'sunil.codewrap37@gmail.com',
};
