          ...
          <div className='flex flex-col items-start justify-start w-full mt-4'>
            ...
            <div className='w-full mt-3 p-4 border border-text-primary/20 rounded-2xl flex items-center justify-between'>
              ...
              <div className='flex items-center gap-4'>
                ...
                <Image onClick={() => router.push('/instacard/add-universal-card/uc-scan')} src={ICONS.scan} alt='scan' width={40} height={24} className='object-contain invert h-5 w-auto' />
              </div>
            </div>
          </div>
          <ButtonComponent title='Apply Now' onClick={() => router.push(routes.addUniversalVerifyMobile)} />
        </div>
    </LayoutSheet>
  )
}
