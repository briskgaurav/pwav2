    ...
    debit: {
        ...
        accordion: [
            ...
            },
            {
                ...
                intro: 'You can link this Virtual Instacard to a Universal Card:',
                bullets: [
...
function HowToUseCardContent({ cardType: CardType }: { cardType: CardType }) {
    ...
    return (
        <>
            <div className="flex flex-col gap-6 pb-[10vh] p-6">
                {/* Header */}
...
export default function HowToUseInstacards({ cardType }: { cardType: CardType }) {
    return (
        <Suspense fallback={<div>Loading...</div>}>
            <HowToUseCardContent cardType={cardType} />
        </Suspense>
    );
}