                    ...
                    {unlinkedUniversalCards.length > 0 && (
                        <>
                            ...
                            {unlinkedUniversalCards.map((card) => (
                                ...
                                >
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedCard === card.cardId ? 'border-orange bg-orange' : 'border-text-primary/40'
                                        }`}>
                                    ...
                                    <span className="text-sm text-text-primary">
                                        {maskCardNumber(card.maskedCardNumber)} ( Universal Card )
                                    </span>
                                </button>
                            ))}
                        </>
