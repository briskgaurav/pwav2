        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              onFocus={handleFocus}
              onBlur={handleBlur}
              className={`text-md focus:outline-none! focus:ring-none! focus:border-none! font-medium bg-transparent border-none outline-none text-right w-24 focus:ring-0! focus:ring-primary/30 rounded px-1 ${error ? 'text-red-500' : 'text-text-primary'}`}
            />
          </div>
        </div>
      </div>
