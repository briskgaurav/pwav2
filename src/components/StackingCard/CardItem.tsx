  ...
  return (
    ...
    >
      <Image
        ...
        draggable={false}
      />
      <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-xl tracking-[0.15em] font-medium drop-shadow-md pointer-events-none w-full select-none">
        {maskedNumber}
      </span>
    </button>
  );
