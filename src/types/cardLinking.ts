/**
 * Types for the VC ↔ UC card-linking flow.
 *
 * Parallels `cardIssuance.ts` but covers the `/api/v1/card-link/...` endpoints.
 * The backend drives screen progression via `nextAction.code` — the same
 * pattern used in VC issuance.
 */
